              ...
              <div className="h-full flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-neutral-500">Edit content and styling for this section</p>
                  </div>
                  ...
                  {getFieldsForSection(selectedSection.sectionType).map((field) => {
                    ...
                    const icon = field.type === 'image' ? <Image className="w-4 h-4" /> : <Type className="w-4 h-4" />;
                      ...
                      <div key={field.editorField}>
                        ...
                        {field.type === 'textarea' ? (
                          <textarea
                            ...
                            className="w-full px-4 py-2.5 border border-neutral-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm resize-none"
                            rows={4}
                          ...
                          <input
                            ...
                            value={selectedSection.content?.[field.editorField] || ''}
                            onChange={(e) => updateSectionContent(field.editorField, e.target.value)}
                            className="w-full px-4 py-2.5 border border-neutral-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                  ...
                  <div>
                    <label className="text-sm font-medium text-neutral-900 block mb-2">Design Style</label>
                    <button
                      onClick={() => {
                        setVariantSectionType(selectedSection.sectionType);
                        setEditingMode('variants');
                      }}
                      className="w-full px-4 py-4 border border-neutral-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors flex items-center justify-between group"
                    >
                      <div className="flex items-center gap-3">
                        <Palette className="w-5 h-5 text-neutral-400 group-hover:text-blue-600" />
